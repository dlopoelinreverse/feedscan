...
export function TryDemoButton() {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={loading}
      className="inline-flex items-center justify-center gap-2 border border-border px-4 py-2 text-sm sm:px-6 sm:py-3 sm:text-base rounded-lg font-medium hover:bg-muted transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
    >
      {loading ? (
        <>
